export const attributes = {
  ...
  "custom-item": {"description": "component name of your customized suggestion list item"},
  ...
  "default-first-option": {"description": "select first matching option on enter key. Use with 'filterable' or 'remote'"},
  ...
  "on-text": {"description": "text displayed when in on state, default: 'ON'"},
  "off-text": {"description": "text displayed when in off state, default: 'OFF'"},
  "on-value": {"description": "switch value when in on state, default: true"},
  "off-value": {"description": "switch value when in off state, default: false"},
  "on-color": {"description": "background color when in on state, default: #20A0FF"},
  "off-color": {"description": "background color when in off state, default: #C0CCDA"},
  ...
  "text-template": {"description": "text template when the component is read-only, example: '{var}'"},
  ...
  "footer-format": {"description": "texts for checking status in list footer, default: { noChecked: '${total} items', hasChecked: '${checked}/${total} checked' }"},
  ...
  "sort-method": {"description": "sorting method, works when sortable is 'true'"},
  ...
  "theme": {"options": ["light", "dark"], "description": "theme color"},
  ...
  "menu-align": {"options": ["start", "end"], "description": "horizontal alignment, default: end"},
  ...
  "placement": {"option": ["top", "top-start", "top-end", "bottom", "bottom-start", "bottom-end", "left", "left-start", "left-end", "right", "right-start", "right-end"], "description": "default: bottom"},
  "value-key": {"description": "unique identity key name for value, required when value is an object"},
  "el-dialog/size": {"options": ["tiny", "small", "large", "full"], "description": "size of dialog, default: small"},
  ...
  "el-tag/type": {"options": ["primary", "gray", "success", "warning", "danger"], "description": "theme"},
  ...
  "expand": {"type": "method", "description": "triggers when user expands or collapses a row, arg: row, expanded"},
  ...
  "on-icon-class": {"type": "icon", "description": "class name of the icon displayed when in on state, overrides 'on-text'"},
  "off-icon-class": {"type": "icon", "description": "class name of the icon displayed when in off state, overrides 'off-text'"},
